...
const MyApplicationsPage = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        ...
        // Normalize: backend returns array of applications
        // Expected shape: { id, job_id, job_title, company_name, company_logo,
        //                   location, type, mode, applied_at, deadline, status, note }
  ...
  if (loading) {
    return (
      <div className="mac">
        <StudentNavbar studentName="Ahmed" notifCount={0} />
